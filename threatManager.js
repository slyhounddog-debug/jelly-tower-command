...
export default class ThreatManager {
    constructor(game) {
        ...
        this.enemyData = [
            ...
            { name: 'gummy_worm', cost: 2, threshold: 14, baseWeight: 80, weightModifier: -0.08 },
            { name: 'donut', cost: 4, threshold: 30, baseWeight: 35, weightModifier: 0.05 },
            { name: 'heartenemy', cost: 6, threshold: 45, baseWeight: 10, weightModifier: 0 },
            { name: 'ice_cream', cost: 7, threshold: 65, baseWeight: 20, weightModifier: 0.08 },
    ...
    update(tsf) {
        this.diffTimer += tsf;
        if (this.diffTimer >= 150) {  // this is the line that determines how quickly threatRPM increases
